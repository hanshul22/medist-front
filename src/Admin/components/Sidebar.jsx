...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-white shadow-md ${collapsed ? 'w-20' : 'w-64'} transition-width duration-300 ease-in-out flex-shrink-0 h-screen`}>
      <div className="flex flex-col h-full">
        <div className="flex items-center justify-between p-4 border-b">
          {!collapsed && (
            <div className="text-xl font-semibold text-primary">Medist Admin</div>
          )}
          <button
            onClick={() => setCollapsed(!collapsed)}
            className={`rounded-full p-1 hover:bg-gray-100 ${collapsed ? 'ml-auto mr-auto' : ''}`}
          >
        ...
        <div className="p-4 border-t">
          <NavLink
            to="/admin_login"
            className="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100"
            onClick={(e) => {
              e.preventDefault();
